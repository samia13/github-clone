  ...
  return (
    <section id='productivity' className='section'>
      <SectionContent
        ...
        content='Our AI-powered platform increases the pace of software development.'
        dividerColor='green'
      >
        <svg
          aria-hidden='true'
      ...
      <SectionStats
        dividerSrc='images/green-branch.svg'
        dividerAlt='branch'
        dividerColor='green'
        statTitle='GitHub Copilot'
        statText='empowers developers to complete tasks 55% faster with
